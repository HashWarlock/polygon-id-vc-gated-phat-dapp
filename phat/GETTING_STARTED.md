...
This is how the e2e mocha test will look like. You can customize this file at [`Counter.ts`](./test/Counter.ts).
...
With our hardhat node running locally, we can now deploy the `Counter.sol` contract to the local hardhat network.
```bash
...
```bash
yarn localhost-watch 0x0165878A594ca255338adfa4d48449f69242Eb8F artifacts/contracts/Counter.sol/Counter.sol.json dist/index.js -a https://api-mumbai.lens.dev/
```

```bash
yarn localhost-watch 0x0165878A594ca255338adfa4d48449f69242Eb8F artifacts/contracts/Counter.sol.sol/Counter.sol.json dist/index.js -a https://api-mumbai.lens.dev/
# $ phat-fn watch 0x0165878A594ca255338adfa4d48449f69242Eb8F artifacts/contracts/Counter.sol/Counter.sol.json dist/index.js -a https://api-mumbai.lens.dev/
# Listening for Counter.sol MessageQueued events...
```
...
```typescript
Listening for Counter MessageQueued events...
...
# contracts/Counter.sol:Counter.sol at 0x090E8fDC571d65459569BC87992C1026121DB955
# for verification on the block explorer. Waiting for verification result...
#
# Successfully verified contract Counter.sol on Etherscan.
...
# No need to generate any newer typings.
# Successfully submitted source code for contract
# contracts/Counter.sol.sol:Counter.sol.sol.sol at 0xbb0d733BDBe151dae3cEf8D7D63cBF74cCbf04C4
# for verification on the block explorer. Waiting for verification result...
#
# Successfully verified contract Counter.sol on Etherscan.
